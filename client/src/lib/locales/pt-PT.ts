...
export const ptPT: TranslationSet = {
  ...
  extraIngredientsLabel: "Falta comprar",
  extraIngredientsHint: "Os extras excluem básicos de despensa assumidos como disponíveis.",
  noExtraIngredientsLabel: "Sem compras extra",
  pantryStaplesNote: "Básicos de despensa assumidos: sal, pimenta, óleo, manteiga, alho, cebola, açúcar e farinha.",
  recipeTrustTitle: "Verificação de compras",
  recipeTrustCopy: "Os ingredientes extra são comparados com o que introduziu. Os básicos de despensa são tratados como já disponíveis.",
  ...
  resultsErrorDetailLabel: "Detalhe técnico",
  ...
  imageUnavailableDetail: "O Mealio não conseguiu concluir a fotografia da receita desta vez. Pode tentar novamente sem perder a receita.",
