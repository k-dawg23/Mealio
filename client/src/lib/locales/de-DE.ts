...
export const deDE: TranslationSet = {
  ...
  extraIngredientsLabel: "Noch besorgen",
  extraIngredientsHint: "Zusätzliche Zutaten schließen angenommene Vorratsartikel aus.",
  noExtraIngredientsLabel: "Kein Extra-Einkauf",
  pantryStaplesNote: "Als Vorrat angenommen: Salz, Pfeffer, Öl, Butter, Knoblauch, Zwiebel, Zucker und Mehl.",
  recipeTrustTitle: "Einkaufscheck",
  recipeTrustCopy: "Zusätzliche Zutaten werden mit deinen Eingaben verglichen. Vorratsartikel gelten als bereits vorhanden.",
  ...
  resultsErrorDetailLabel: "Technisches Detail",
  ...
  imageUnavailableDetail: "Mealio konnte das Essensfoto diesmal nicht fertigstellen. Du kannst es erneut versuchen, ohne das Rezept zu verlieren.",
