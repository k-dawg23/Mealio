...
export const enGB: TranslationSet = {
  ...
  extraIngredientsLabel: "Need to buy",
  extraIngredientsHint: "Extras exclude assumed pantry staples.",
  noExtraIngredientsLabel: "No extra shopping",
  pantryStaplesNote: "Pantry staples assumed: salt, pepper, oil, butter, garlic, onion, sugar, and flour.",
  recipeTrustTitle: "Shopping check",
  recipeTrustCopy: "Extra ingredients are compared against what you entered. Pantry staples are treated as already on hand.",
  ...
  resultsErrorDetailLabel: "Technical detail",
  ...
  imageUnavailableDetail: "Mealio could not finish the food photo this time. You can retry without losing the recipe.",
