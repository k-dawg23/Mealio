...
export const frFR: TranslationSet = {
  ...
  extraIngredientsLabel: "À acheter",
  extraIngredientsHint: "Les extras excluent les basiques de placard supposés disponibles.",
  noExtraIngredientsLabel: "Aucun achat en plus",
  pantryStaplesNote: "Basiques supposés disponibles : sel, poivre, huile, beurre, ail, oignon, sucre et farine.",
  recipeTrustTitle: "Vérification des achats",
  recipeTrustCopy: "Les ingrédients en plus sont comparés à ce que vous avez saisi. Les basiques de placard sont considérés comme déjà disponibles.",
  ...
  resultsErrorDetailLabel: "Détail technique",
  ...
  imageUnavailableDetail: "Mealio n’a pas pu terminer la photo du plat cette fois-ci. Vous pouvez réessayer sans perdre la recette.",
